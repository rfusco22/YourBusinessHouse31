              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <div className="[&>div>input]:pl-10 [&>div>input]:sm:pl-12 [&>div>input]:bg-white/10 [&>div>input]:text-white [&>div>input]:placeholder:text-white/50 [&>div>input]:border-white/20 [&>div>input]:focus:ring-primary">
                      <LocationAutocomplete value={location} onChange={setLocation} placeholder="Ubicación" />
                    </div>
                  </div>
