...
import { AlertCircle, Bell, BookOpen, Users, LayoutDashboard, AlertCircleIcon, Home } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-neutral-900 to-black">
      ...
      <main className={cn("transition-all duration-500 px-6 py-8", sidebarCollapsed ? "ml-20" : "ml-64")}>
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-white">Todas las Alertas de Propiedades</h2>
          <p className="text-xs text-gray-400 mt-1">Vista completa - Sistema automatizado que ejecuta cada hora</p>
        </div>
        ...
        <div className="mb-6 bg-green-500/10 border border-green-500/30 rounded-lg p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white font-medium">Sistema de Notificaciones Automáticas - Vista Completa</p>
              <p className="text-gray-400 text-sm mt-1">
                Como gerencia, ves TODAS las alertas del sistema. Las notificaciones se envían automáticamente por
                WhatsApp a todos los involucrados (asesores, admins y gerencia) cuando los inmuebles superan el tiempo
                sin actualizar.
              </p>
            </div>
          </div>
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 space-y-1 text-xs text-gray-400">
                        ...
                        <p>
                          Asesor: {alert.agentName} ({alert.agentRole})
                        </p>
